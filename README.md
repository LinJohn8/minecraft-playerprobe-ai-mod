...
- `/explore/markers` exposes local exploration memory for waypoints and manually recorded positions, persisted locally under `~/.playerprobe/explore-markers.json`.
